...
freainq._rRem = function(key, fn)
{
	return fn.removeItem(key);
}

freainq.LocalGet = function(key)
{
	return this._rGet(key, localStorage);
};

freainq.SessionGet = function(key)
{
	return this._rGet(key, sessionStorage);
};

freainq.LocalRemove = function(key)
{
	var data = this._rGet(key, localStorage);
	this._rRem(key, localStorage);
	
	return data;
};

freainq.SessionRemove = function(key)
{
	var data = this._rGet(key, sessionStorage);
	this._rRem(key, sessionStorage);
